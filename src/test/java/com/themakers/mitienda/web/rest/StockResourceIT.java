package com.themakers.mitienda.web.rest;

import com.themakers.mitienda.MitiendaApp;
import com.themakers.mitienda.domain.Stock;
import com.themakers.mitienda.domain.Producto;
import com.themakers.mitienda.domain.Sucursal;
import com.themakers.mitienda.repository.StockRepository;
import com.themakers.mitienda.service.StockService;
import com.themakers.mitienda.service.dto.StockDTO;
import com.themakers.mitienda.service.mapper.StockMapper;
import com.themakers.mitienda.web.rest.errors.ExceptionTranslator;
import com.themakers.mitienda.service.dto.StockCriteria;
import com.themakers.mitienda.service.StockQueryService;
...
import static com.themakers.mitienda.web.rest.TestUtil.createFormattingConversionService;
...
public class StockResourceIT {
    ...
    @Test
    @Transactional
    public void getAllStocksBySucursalIsEqualToSomething() throws Exception {
        // Initialize the database
        stockRepository.saveAndFlush(stock);
        ...
        // Get all the stockList where sucursal equals to sucursalId
        defaultStockShouldBeFound("sucursalId.equals=" + sucursalId);

        // Get all the stockList where sucursal equals to sucursalId + 1
        defaultStockShouldNotBeFound("sucursalId.equals=" + (sucursalId + 1));
    }
